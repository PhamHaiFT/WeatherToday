package com.wweeaatthheerr.ttooddaayy.database;
...
public class HistoryDatabase extends SQLHelper {
    ...
    public void addNewLocation(String cityName) {
        ...
        contentValues.put(COLUMN_LOCATION, cityName);
    ...
    public ArrayList<String> getListLocation() {
        ...
        while (cursor.isAfterLast() == false) {
            listLocation.add(cursor.getString(cursor.getColumnIndex(COLUMN_LOCATION)));
            cursor.moveToNext();
        }
        return listLocation;
    }
